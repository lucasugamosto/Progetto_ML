...
2) Il file "projectML.ipynb", in cui è presente un metodo per l'addestramento della rete neurale composto da funzioni
...
3) Il file "projectML_2.ipynb", dove viene definita una funzione per la creazione della rete neurale e si usa la classe
...
4) Il file "projectML_3.ipynb", in cui viene inizializzata una Convolutional Neural Network (leNet-5).
